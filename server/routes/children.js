...
//Gestione Figli: Gli endpoint GET /api/children, 
//POST /api/children e
//DELETE /api/children/:id permettono di gestire i profili dei figli
//(aggiungere, visualizzare ed eliminare). Questi endpoint sono protetti e richiedono l'autenticazione.
