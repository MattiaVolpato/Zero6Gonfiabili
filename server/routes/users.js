...
//Profilo Utente: L'endpoint GET /api/users/me restituisce i dati pubblici dell'utente loggato (id, nome, email, ecc.).
// Aggiornamento Profilo: L'endpoint PUT /api/users/me permette all'utente di modificare i propri dati personali (indirizzo, telefono, ecc.).
// Cambio Password: L'endpoint POST /api/users/change-password consente all'utente di cambiare la propria password, verificando prima la password attuale.
// Eliminazione Account: L'endpoint DELETE /api/users/me permette all'utente di eliminare il proprio account, richiedendo la password attuale per motivi di sicurezza.
