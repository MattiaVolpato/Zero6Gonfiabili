    ...
    if (trimmedCode) {
      ...
      if (lv) {
        ...
        if (!check || !check.valid) {
          //il comando ROLLBACK serve a annullare tutte le modifiche apportate durante la transazione 
          //corrente, riportando i dati allo stato esatto in cui si trovavano prima
          //del comando BEGIN TRANSACTION.
