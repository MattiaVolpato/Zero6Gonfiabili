// --- REVEAL ON SCROLL: Animazioni allo Scroll ---
/**
 * Questo script gestisce le animazioni "reveal" (comparsa graduale) degli elementi quando entrano nel viewport.
 * 
 * Funzionalità principali:
 * 1. IntersectionObserver: Usa l'API moderna per rilevare efficientemente quando un elemento è visibile.
 * 2. Rispetto Preferenze Utente: Disabilita le animazioni se l'utente ha impostato "prefers-reduced-motion".
 * 3. Supporto SPA: Monitora il DOM con MutationObserver per animare anche elementi caricati dinamicamente (es. cambio pagina).
 * 4. Configurazione via attributi HTML:
 *    - class="reveal": Attiva l'animazione base.
 *    - data-reveal-repeat="true": Ripete l'animazione ogni volta che l'elemento rientra nel viewport.
 *    - data-reveal-once="false": (Opzionale) Forza l'osservazione continua.
 */
