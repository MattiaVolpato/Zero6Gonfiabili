/**
 * gonfiabile-dettaglio-page.js
 *
 * Script che gestisce la pagina di dettaglio di un singolo gonfiabile.
 * Funzionalità principali:
 * - Recupera l'ID del gonfiabile dall'URL.
 * - Effettua una chiamata API per ottenere i dati del gonfiabile.
 * - Renderizza le informazioni (titolo, immagine, descrizione, prezzo, specifiche).
 * - Gestisce l'aggiunta/rimozione dai preferiti.
 * - Carica e mostra le recensioni esistenti.
 * - Gestisce il form per l'invio di nuove recensioni (se l'utente è loggato e abilitato).
 */
...
//pagina per il dettaglio del gonfiabile
