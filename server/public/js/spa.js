import { initHomeReviews, initHomeNewsletter, initHomeItems } from "./pages/home-page.js";
...
export function pageInitDispatcher(viewPath, root) {
  try {
    ...
    // EX: if (root.querySelector("#items-list")) initGonfiabiliPage();
    // NOW: use specific view path
    if (viewPath === "gonfiabili") initGonfiabiliPage();
