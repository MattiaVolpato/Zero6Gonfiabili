...
async function createAndConfigureDb() {
  ...
  // Migrazioni "soft" idempotenti (solo ciò che serve qui)
...
/**
 * Migrazioni idempotenti leggere: qui creiamo solo le tabelle
 * che questo modulo garantisce (non tocchiamo schema esistente).
 * - email_reminders: tracking invii promemoria compleanni
 */
...
// Usa un singleton anche con nodemon/hot-reload
const dbPromise =
