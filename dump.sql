...
-- Dati per: sessions
INSERT INTO sessions (sid, expired, sess) VALUES ('otNflCB69Nt2PEAjlQU8QQGsUJ-vD86r', 1770823741143, '{"cookie":{"originalMaxAge":7200000,"expires":"2026-02-11T15:28:34.069Z","secure":false,"httpOnly":true,"path":"/","sameSite":"lax"},"passport":{"user":2},"rememberMe":false}');
...
INSERT INTO email_reminders (id, reminder_type, user_id, child_id, target_date, sent_at) VALUES (25, 'birthday-1m', 2, 8, '2026-03-10', '2026-02-10 13:34:18');
...
-- Dati per: users
INSERT INTO users (id, first_name, last_name, email, password_hash, city, cap, address, role, birthday, phone, reset_token, reset_expires) VALUES (1, 'Mario', 'Rossi', 'test@example.com', '$2b$10$9R2VyzQ64AjoezgOGgVasOI1z4C8iVhAhoE1oxWKp.w2KwLWEYQQy', 'Padova', '35100', 'Via Roma 1', 'user', NULL, '3401234567', NULL, NULL);
INSERT INTO users (id, first_name, last_name, email, password_hash, city, cap, address, role, birthday, phone, reset_token, reset_expires) VALUES (2, 'Admin', 'Site', 'admin@example.com', '$2b$10$Oh6lWcEus6K7vF2tqv/NI.UVOYeFR9qXIBeTy2SYHATliH1FEkJd6', 'Padova', '35100', 'Via Verdi 2', 'admin', NULL, '3494321239', NULL, NULL);
INSERT INTO users (id, first_name, last_name, email, password_hash, city, cap, address, role, birthday, phone, reset_token, reset_expires) VALUES (3, 'Lucia', 'Bianchi', 'lucia@example.com', '$2b$10$9R2VyzQ64AjoezgOGgVasOI1z4C8iVhAhoE1oxWKp.w2KwLWEYQQy', 'Venezia', '30100', 'Calle Lunga 42', 'user', NULL, '3339876543', NULL, NULL);
INSERT INTO users (id, first_name, last_name, email, password_hash, city, cap, address, role, birthday, phone, reset_token, reset_expires) VALUES (4, 'Marco', 'Verdi', 'marco@example.com', '$2b$10$9R2VyzQ64AjoezgOGgVasOI1z4C8iVhAhoE1oxWKp.w2KwLWEYQQy', 'Treviso', '31100', 'Piazza dei Signori 5', 'user', NULL, '3201122334', NULL, NULL);
INSERT INTO users (id, first_name, last_name, email, password_hash, city, cap, address, role, birthday, phone, reset_token, reset_expires) VALUES (5, 'Sara', 'Neri', 'sara@example.com', '$2b$10$9R2VyzQ64AjoezgOGgVasOI1z4C8iVhAhoE1oxWKp.w2KwLWEYQQy', 'Vicenza', '36100', 'Corso Palladio 10', 'user', NULL, '3475566778', NULL, NULL);
...
-- Dati per: addresses
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (1, 1, 'Casa', 'Padova', '35100', 'Via Roma 1', '2026-02-11 13:29:13');
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (2, 1, 'Casa al mare', 'Jesolo', '30016', 'Via Bafile 20', '2026-02-11 13:29:13');
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (3, 1, 'Ufficio', 'Mestre', '30170', 'Via Torino 15', '2026-02-11 13:29:13');
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (4, 3, 'Casa', 'Venezia', '30100', 'Calle Lunga 42', '2026-02-11 13:29:13');
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (5, 3, 'Casa Genitori', 'Mirano', '30035', 'Via della Vittoria 8', '2026-02-11 13:29:13');
INSERT INTO addresses (id, user_id, label, city, cap, address, created_at) VALUES (6, 4, 'Casa', 'Treviso', '31100', 'Piazza dei Signori 5', '2026-02-11 13:29:13');
...
-- Dati per: bookings
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (1, 1, 1, 'Via Roma 1, Padova', '2026-02-01', '2026-02-03', NULL, 100, 0, 300, 'credit_card', 'paid', 'finished', '2026-01-27', '2026-02-11 13:29:13');
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (2, 1, 2, 'Via Bafile 20, Jesolo', '2026-02-21', '2026-02-23', NULL, 150, 0, 450, 'paypal', 'paid', 'confirmed', '2026-02-09', '2026-02-11 13:29:13');
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (3, 3, 3, 'Calle Lunga 42, Venezia', '2026-02-16', '2026-02-17', NULL, 80, 0, 160, 'cash', 'unpaid', 'pending', '2026-02-10', '2026-02-11 13:29:13');
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (4, 3, 4, 'Calle Lunga 42, Venezia', '2026-01-22', '2026-01-23', NULL, 180, 0, 360, 'credit_card', 'paid', 'cancelled', '2026-01-17', '2026-02-11 13:29:13');
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (5, 4, 2, 'Piazza dei Signori 5, Treviso', '2026-01-02', '2026-01-04', NULL, 150, 0, 450, 'paypal', 'paid', 'finished', '2025-12-28', '2026-02-11 13:29:13');
INSERT INTO bookings (id, user_id, item_id, shipping_address, date_from, date_to, coupon_code, unit_price, discount_percent, final_price, payment_method, payment_status, status, created_at, updated_at) VALUES (6, 4, 4, 'Piazza dei Signori 5, Treviso', '2026-02-06', '2026-02-07', NULL, 180, 0, 360, 'cash', 'paid', 'finished', '2026-02-01', '2026-02-11 13:29:13');
...
-- Dati per: children
INSERT INTO children (id, user_id, name, birthday, created_at) VALUES (1, 1, 'Giulia', '2018-05-12', '2026-02-11 13:29:13');
INSERT INTO children (id, user_id, name, birthday, created_at) VALUES (2, 1, 'Luca', '2020-11-03', '2026-02-11 13:29:13');
INSERT INTO children (id, user_id, name, birthday, created_at) VALUES (3, 3, 'Sofia', '2019-02-14', '2026-02-11 13:29:13');
INSERT INTO children (id, user_id, name, birthday, created_at) VALUES (4, 3, 'Matteo', '2021-08-20', '2026-02-11 13:29:13');
INSERT INTO children (id, user_id, name, birthday, created_at) VALUES (5, 4, 'Chiara', '2015-06-30', '2026-02-11 13:29:13');
...
-- Dati per: coupons
INSERT INTO coupons (id, code, discount_percent, starts_at, expires_at, is_active) VALUES (1, 'FESTA10', 10, '2026-01-12', '2026-08-10', 1);
INSERT INTO coupons (id, code, discount_percent, starts_at, expires_at, is_active) VALUES (2, 'SUPER20', 20, '2026-02-01', '2026-03-13', 1);
INSERT INTO coupons (id, code, discount_percent, starts_at, expires_at, is_active) VALUES (3, 'SCADUTO', 15, '2025-12-13', '2026-02-10', 1);
INSERT INTO coupons (id, code, discount_percent, starts_at, expires_at, is_active) VALUES (4, 'ESTATE25', 25, '2026-04-12', '2026-06-11', 1);
...
INSERT INTO newsletter_subscriptions (id, user_id, email, is_active, subscribed_at, unsubscribed_at) VALUES (1, 1, 'test@example.com', 1, '2026-02-11 13:29:13', NULL);
INSERT INTO newsletter_subscriptions (id, user_id, email, is_active, subscribed_at, unsubscribed_at) VALUES (2, 3, 'lucia@example.com', 1, '2026-02-11 13:29:13', NULL);
INSERT INTO newsletter_subscriptions (id, user_id, email, is_active, subscribed_at, unsubscribed_at) VALUES (3, NULL, 'anonimo@gmail.com', 1, '2026-02-11 13:29:13', NULL);
INSERT INTO newsletter_subscriptions (id, user_id, email, is_active, subscribed_at, unsubscribed_at) VALUES (4, NULL, 'fan@hotmail.it', 1, '2026-02-11 13:29:13', NULL);
INSERT INTO newsletter_subscriptions (id, user_id, email, is_active, subscribed_at, unsubscribed_at) VALUES (5, 4, 'marco@example.com', 0, '2026-02-11 13:29:13', NULL);
...
-- Dati per: reviews
INSERT INTO reviews (id, user_id, item_id, rating, comment, created_at, is_approved) VALUES (1, 1, 1, 5, 'Fantastico! I miei figli lo hanno adorato. Servizio puntuale.', '2026-02-04', 1);
INSERT INTO reviews (id, user_id, item_id, rating, comment, created_at, is_approved) VALUES (2, 4, 2, 4, 'Bello ma un po’ difficile da montare se non si ha spazio.', '2026-02-08', 1);
INSERT INTO reviews (id, user_id, item_id, rating, comment, created_at, is_approved) VALUES (3, 4, 4, 5, 'Consigliatissimo per feste numerose!', '2026-02-10', 0);
INSERT INTO reviews (id, user_id, item_id, rating, comment, created_at, is_approved) VALUES (4, 3, 3, 2, 'Purtroppo è arrivato un po’ sporco.', '2026-02-11', 0);
